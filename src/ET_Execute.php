...
use \SoapVar;
/**
 * This class represents the POST operation Execute Method for SOAP service.
 */
class ET_Execute extends ET_Constructor
{
	/**
	...
	*/
	function __construct($authStub, $objType, $props, $upsert = false)
	{
		...
		$cr["ExecuteRequest"] = $objects;
		$return = $authStub->__soapCall("Execute", $cr, null, null , $out_header);
